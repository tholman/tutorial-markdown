(function (global, factory) {
  ...
  (global = global || self, global.TutorialMarkdown = factory());
  ...
  function () {
    function CodeBlock(element, codeSelector, tabSize) {
      ...
      this.lines = this.code.split('\n').length; // Set "TO" value to from + lines it isn't set
    ...
    _createClass(CodeBlock, [{
      ...
      value: function shouldBeActive() {
        var rect = this.element.getBoundingClientRect(); // 1/3 of rect is at 1/2 of window
  ...
  function () {
    ...
    _createClass(EditorManager, [{
      ...
      value: function executeBlock(block) {
        ...
        this.editor.revealLines(block.from, block.from + block.lines); // Save last state (to undo any manually typed code)
  ...
  var TutorialMarkdown =
  /*#__PURE__*/
  function () {
    function TutorialMarkdown(options) {
      _classCallCheck(this, TutorialMarkdown);
